  ...
  ((a.esri.Services.Geocoding = a.esri.Services.Service.extend({
    ...
    initialize: function (b, c) {
      ((b =
        "string" == typeof b
          ? b
          : a.esri.Services.Geocoding.WorldGeocodingService),
    ...
    geocode: function (b, c, d, e) {
      var f = {
          outFields:
            "Subregion, Region, PlaceName, Match_addr, Country, Addr_type, City, Place_addr",
        },
        g = a.extend(f, c);
      ((g.text = b),
        this.get(
    ...
    suggest: function (a, b, c, d) {
      var e = b || {};
      ((e.text = a), this.get("suggest", e, c, d));
    },
    ...
    (a.esri.Controls.Geosearch = a.Control.extend({
      ...
      initialize: function (b) {
        (a.Util.setOptions(this, b),
          ...
          this._service.on(
            ...
            function (b) {
              ((b = a.extend({ target: this }, b)), this.fire(b.type, b));
            },
            this,
          ));
      },
      _geocode: function (b, c) {
        ...
        if (c) d.magicKey = c;
          ...
          ((d.maxLocations = this.options.maxResults),
          this.options.useMapBounds === !0 ||
            this.options.useMapBounds <= this._map.getZoom())
        ) {
          ...
          this._service.geocode(
            ...
            function (c, d) {
              if (d && d.length) {
                ...
                for (e = d.length - 1; e >= 0; e--) f.extend(d[e].bounds);
                (this.fire("results", {
                  results: d,
                  bounds: f,
                  latlng: f.getCenter(),
      ...
      onAdd: function (b) {
        return (
          (this._map = b),
          b.attributionControl &&
            b.attributionControl.addAttribution("Geocoding by Esri"),
          (this._container = a.DomUtil.create(
            "div",
            "geocoder-control" +
              (this.options.expanded ? " geocoder-control-expanded" : ""),
          )),
          (this._input = a.DomUtil.create(
            "input",
            "geocoder-control-input leaflet-bar",
            this._container,
          )),
          (this._suggestions = a.DomUtil.create(
            "ul",
          ...
          a.DomEvent.addListener(
            ...
            function (a) {
              ...
              (this._geocode(b.innerHTML, b["data-magic-key"]), this.clear());
            },
            this,
          ),
          a.DomEvent.addListener(
          ...
          a.DomEvent.addListener(
            ...
            function (b) {
              a.DomUtil.addClass(this._container, "geocoder-control-expanded");
              var c = this._suggestions.querySelectorAll(
                ".geocoder-control-selected",
              )[0];
              switch (b.keyCode) {
                case 13:
                  (c
                    ? (this._geocode(c.innerHTML, c["data-magic-key"]),
                      this.clear())
                    : this.options.allowMultipleResults
                      ? (this._geocode(this._input.value), this.clear())
                      : a.DomUtil.addClass(
                          this._suggestions.childNodes[0],
                          "geocoder-control-selected",
                        ),
                ...
                case 38:
                  (c && a.DomUtil.removeClass(c, "geocoder-control-selected"),
                    c && c.previousSibling
                      ...
                      : a.DomUtil.addClass(
                          this._suggestions.childNodes[
                            this._suggestions.childNodes.length - 1
                          ],
                          "geocoder-control-selected",
                        ),
                    a.DomEvent.preventDefault(b));
              ...
              return c.length < 2
                ...
                : 27 === b
                  ? ((this._suggestions.innerHTML = ""),
                    (this._suggestions.style.display = "none"),
                    void 0)
                  : (13 !== b && 38 !== b && 40 !== b && this._suggest(c),
                    void 0);
            },
            this,
          ),
