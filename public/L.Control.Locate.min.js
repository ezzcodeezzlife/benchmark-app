  ...
  var i = function (i, o, s) {
    ...
    e = t.Marker.extend({
      ...
      createIcon: function () {
        var i = this.options,
          o = "";
        (void 0 !== i.color && (o += "stroke:" + i.color + ";"),
          void 0 !== i.weight && (o += "stroke-width:" + i.weight + ";"),
          void 0 !== i.fillColor && (o += "fill:" + i.fillColor + ";"),
          void 0 !== i.fillOpacity &&
            (o += "fill-opacity:" + i.fillOpacity + ";"),
          void 0 !== i.opacity && (o += "opacity:" + i.opacity + ";"));
    ...
    a = t.Control.extend({
      options: {
        ...
        createButtonCallback: function (i, o) {
          ...
          return (
            ...
            (s.role = "button"),
            (s.href = "#"),
            { link: s, icon: t.DomUtil.create(o.iconElementTag, o.icon, s) }
          );
        },
      ...
      initialize: function (i) {
        for (var o in i)
          "object" == typeof this.options[o]
            ? t.extend(this.options[o], i[o])
            : (this.options[o] = i[o]);
          ...
          if (i || "ondeviceorientation" in window) {
            var o = this,
              s = function () {
                t.DomEvent.on(
                  window,
                  i ? "deviceorientationabsolute" : "deviceorientation",
      ...
      setView: function () {
        if ((this._drawMarker(), this._isOutsideMapBounds()))
          ...
          (i = this.options.flyTo ? this._map.flyTo : this._map.setView).bind(
            this._map,
          )(
          ...
          (i = this.options.flyTo ? this._map.flyTo : this._map.panTo).bind(
            this._map,
          )([this._event.latitude, this._event.longitude]);
        } else {
          var i = this.options.flyTo
            ? this._map.flyToBounds
            : this._map.fitBounds;
          ((this._ignoreEvent = !0),
            i.bind(this._map)(this.options.getLocationBounds(this._event), {
      ...
      _drawMarker: function () {
        ...
        if (this.options.drawCircle) {
          ...
          this._circle
            ...
            : (this._circle = t.circle(e, s, n).addTo(this._layer));
        }
        if (
          (this.options.metric
            ? ((i = s.toFixed(0)), (o = this.options.strings.metersUnit))
            : ((i = (3.2808399 * s).toFixed(0)),
        ...
        function r() {
          return "string" == typeof h
            ? t.Util.template(h, { distance: i, unit: o })
            : "function" == typeof h
              ? h({ distance: i, unit: o })
              : h;
        }
