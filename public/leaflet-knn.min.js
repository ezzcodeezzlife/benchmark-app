!(function (e) {
  if ("function" == typeof bootstrap) bootstrap("leafletknn", e);
  else if ("object" == typeof exports) module.exports = e();
  else if ("function" == typeof define && define.amd) define(e);
  else if ("undefined" != typeof ses) {
    if (!ses.ok()) return;
    ses.makeLeafletKnn = e;
  } else
      ...
      1: [
        function (require, module) {
          function collapse(results) {
            for (var l = [], included = {}, i = 0; i < results.length; i++)
              void 0 == included[L.stamp(results[i].layer)] &&
                (l.push(results[i]),
                (included[L.stamp(results[i].layer)] = !0));
            return l;
          }
          function reformat(coords, layer) {
            for (var l = [], i = 0; i < coords.length; i++)
          ...
          function flat(coords) {
            ...
            if (
              ...
              "object" == typeof coords[0][0] &&
              "object" == typeof coords[0][0][0]
            ) {
            ...
            return "object" == typeof coords[0] ? coords : [coords];
          }
          ...
          module.exports = function (layer) {
            ...
            function collectPoints(l) {
              points = points.concat(
                reformat(flat(l.feature.geometry.coordinates), l),
              );
            }
            if (!(layer instanceof L.GeoJSON))
              throw new Error("must be L.GeoJSON");
            var points = [];
            ...
            return (
              (sknn.nearest = function (p, n, max_distance) {
                return (
                  ...
                  sknn(p[1], p[0], n, max_distance)
                );
              }),
              (sknn.nearestLayer = function (p, n, max_distance) {
                return (
                  p instanceof L.LatLng && (p = [p.lng, p.lat]),
                  collapse(sknn(p[1], p[0], n, max_distance))
                );
              }),
              sknn
            );
      ...
      3: [
        function (require, module, exports) {
          ...
          ((exports.search = function (item, array, comparator) {
            ...
            for (var mid, comp, low = 0, high = array.length - 1; high >= low; )
              if (
                ((mid = (low + high) >>> 1),
            ...
            (exports.insert = function (item, array, comparator) {
              ...
              (0 > i && (i = -(i + 1)), array.splice(i, 0, item));
            }));
        },
        {},
      ],
      4: [
        function (require, module, exports) {
          ...
          function distance(a, b) {
            for (var k, i = Math.min(a.length, b.length), d = 0; i--; )
              ((k = b[i] - a[i]), (d += k * k));
            return d;
          }
          ...
          function buildrec(array, depth) {
            ...
            var i = Math.floor(0.5 * array.length);
            return (
              ++depth,
              new Node(
                axis,
          ...
          function lookup(position, node, n, max) {
            ...
            var array = [];
            if (null === node || 0 >= n) return array;
            for (var dist, i, stack = [node, 0]; stack.length; )
              if (
                ((dist = stack.pop()),
                (node = stack.pop()),
                !(
                  dist > max ||
                  (array.length === n &&
                    array[array.length - 1].dist < dist * dist)
                ))
              ) {
                for (; node instanceof Node; )
                  position[node.axis] < node.split
                ...
                ((dist = distance(position, node.position)),
                  max * max >= dist &&
                    binary.insert(
                      { object: node, dist: dist },
                      array,
                      byDistance,
                    ),
                  array.length > n && array.pop());
              }
            for (i = array.length; i--; ) array[i] = array[i].object;
            return array;
          }
          var binary = require("./binary");
          ((exports.build = build), (exports.lookup = lookup));
        },
        { "./binary": 3 },
      ],
      5: [
        function (require, module, exports) {
            ...
            (object.hasOwnProperty("lat")
              ...
              : object.hasOwnProperty("latitude")
                ...
                : object.hasOwnProperty("location") &&
                  ...
                  2 === object.location.length &&
                  (lat = object.location[0]),
              object.hasOwnProperty("lon")
                ? (lon = object.lon)
                : object.hasOwnProperty("longitude")
                  ? (lon = object.longitude)
                  : object.hasOwnProperty("lng")
                    ? (lon = object.lng)
                    : object.hasOwnProperty("long")
                      ? (lon = object.long)
                      : object.hasOwnProperty("location") &&
                        Array.isArray(object.location) &&
                        2 === object.location.length &&
          ...
          function build(array) {
            for (var i = array.length, out = new Array(i); i--; )
          ...
          function lookup(lat, lon, node, n, max) {
            for (
              var array = kd.lookup(
                  ...
                  node,
                  n,
                  max > 0 ? 2 * Math.sin(max * invEarthDiameter) : void 0,
                ),
                i = array.length;
              i--;
